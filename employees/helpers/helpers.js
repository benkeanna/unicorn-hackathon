const Male = "male";
const Female = "female";
const MaleNames = ['Václav', 'Miroslav', 'Petr', 'Michal', 'Jiří', 'Jaromír', 'Zdeněk', 'Tomáš', 'Adrian', 'Jan', 'Martin', 'Pavel', 'Robert', 
...
const MaleSurnames = ['Kamrád', 'Štencel', 'Urzedovský', 'Oškera', 'Peinelt', 'Pangrác', 'Herynek', 'Číž', 'Vaněk', 'Bečán', 'Hercík', 'Soural', 
...
const FemaleNames = ['Zdeňka', 'Radka', 'Martina', 'Libuše', 'Kateřina', 'Marie', 'Jana', 'Stanislava', 'Božena', 'Naděžda', 'Monika', 'Lenka', 'Kristýna', 
...
const FemaleSurnames = ['Paličková', 'Mirgová', 'Opichalová', 'Kuřová', 'Kaufová', 'Holubová', 'Bláhová', 'Zadinová', 'Stránská', 'Uhlířová', 'Kapešová', 
